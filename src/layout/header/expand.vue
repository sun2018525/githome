...
export default defineComponent({
  ...
  setup(props: IExpand) {
    ...
    const headLogo=httpUrl+store.state.user.headUrl;
...
<template>
  <div class="rr-header-right-items">
    ...
    <div style="display: flex; justify-content: center; align-items: center">
      <img :src="store.state.user.headUrl?headLogo:userLogo" :alt="props.userName" style="width: 30px; height: 30px; border-radius: 50%; margin-top: 3px; margin-right: 5px" />
