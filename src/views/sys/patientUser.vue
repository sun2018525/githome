<template>
  <div class="mod-sys__user">
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border @selection-change="state.dataListSelectionChangeHandle" @sort-change="state.dataListSortChangeHandle" style="width: 100%">
      ...
      <el-table-column prop="username" label="账号" sortable="custom" header-align="center" align="center" width="80"></el-table-column>
      <el-table-column prop="realName" label="姓名" sortable="custom" header-align="center" align="center" width="80"></el-table-column>
      <el-table-column prop="mobile" label="手机号" sortable="custom" header-align="center" align="center" width="80"></el-table-column>
      ...
      <el-table-column prop="email" label="邮箱" header-align="center" align="center" width="80"></el-table-column>
      ...
      <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
        <template v-slot="scope">
          <el-button v-if="state.hasPermission('sys:user:update')" type="primary" link @click="addOrUpdateHandle(scope.row.id)" icon="Edit">修改</el-button>
          <el-button v-if="state.hasPermission('sys:user:delete')" type="danger" link @click="state.deleteHandle(scope.row.id)" icon="Delete">删除</el-button>
...
import AddOrUpdate from "./patientUser-add-or-update.vue";
...
const view = reactive({
  getDataListURL: "/sys/user/patientPage",
