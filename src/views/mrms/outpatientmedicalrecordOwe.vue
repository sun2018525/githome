<template>
  <div class="mod-demo__mrmsoutpatientmedicalrecord">
    ...
    <el-table v-loading="state.dataListLoading" :data="state.dataList" border @selection-change="state.dataListSelectionChangeHandle" style="width: 100%">
      ...
      <el-table-column prop="examDate" label="看诊日期" header-align="center" align="center" width="100"></el-table-column>
      ...
      <!-- <el-table-column label="操作" fixed="right" header-align="center" align="center" width="150">
        <template v-slot="scope">
          <el-button type="primary" link @click="addOrUpdateHandle(scope.row.id)">详情</el-button>
        </template>
      </el-table-column> -->
    </el-table>
...
const view = reactive({
  ...
  exportURL: "/mrms/outpatientMedicalRecord/export",
