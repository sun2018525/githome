...
export const isIdCard = (s: string): boolean => {
  // 18位身份证号码的正则表达式
const idCardRegex = /^[1-9]\d{5}(19|20)\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\d{3}[\dXx]$/;

// 15位身份证号码的正则表达式
const idCardRegex15 = /^[1-9]\d{5}\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\d{3}$/;
  return idCardRegex.test(s)||idCardRegex15.test(s);
};
/**
 * URL地址
 * @param {*} s
